...
class Model:
    ...
    def __init__(self, savior_id: str, amulet_tools: dict[str, Callable]):
        ...
        self.tools_to_functions = {
            ...
            **amulet_tools,
            ...
            "describe_user_view": self.describe_user_view
        }
    ...
    def encode_image(self, image: BytesIO) -> str:
    ...
    def get_chat_completion(self, messages: list[dict], tools: list = None) -> dict:
        ...
        res = self.client.chat.completions.create(
            ...
            messages=messages,
            tools=tools,
            temperature=0.7,  # self.chat_temperature
        )
    ...
    def __call__(self, audio_file: str) -> str:
        ...
        Args:
            audio_bytes: The file location of a user's request

        Returns: An audio file location reference containing the tts response
        """
        print("whisper starting")
        text = self.audio_to_text(audio_file=audio_file)
